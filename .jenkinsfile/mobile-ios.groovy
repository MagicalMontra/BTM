pipeline {
    agent {
        node {
            ...
            customWorkspace 'workspace/booster-math-dev-ios'
            ...
            steps {
                ...
                lock('unity') {
                    ...
                    buildUnity(
                        ...
                        development: false,
                        obb: false,
                        symbols: 'DEBUG;DEBUG_BUILD;CHEAT_ENABLED;MOBILE_DEVICE;TextMeshPro;INPUT_SYSTEM_PACKAGE;UNITASK_DOTWEEN_SUPPORT;ODIN_INSPECTOR;ODIN_INSPECTOR_3;ODIN_INSPECTOR;ODIN_INSPECTOR_3;MOREMOUNTAINS_FEEDBACKS;MOREMOUNTAINS_TOOLS;MOREMOUNTAINS_TOOLS_FOR_MMFEEDBACKS;MOREMOUNTAINS_TEXTMESHPRO_INSTALLED;MOREMOUNTAINS_NICEVIBRATIONS_INSTALLED;',
                        compression: 'lz4hc',
