Shader "Custom/UI/Alpha Blended/Dust Vertex Color"
{
    Properties
    {
        ...
        _spkAddBrigness("Add Brightness", Float) = 1
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                float spkMask = saturate(((spkPanner1 - noiseMask1) + (spkPanner2 - noiseMask2) + _spkAddBrigness) * spriteTex.r);
                fixed4 color = fixed4(i.color.rgb, i.color.a * spkMask) * _spkBrigness;
