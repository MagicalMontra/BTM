...
{
    public class ScoreBoostItemDrop : ItemDropBase
    {
        [InjectLocal]
        ...
        public override async UniTask Activate()
        {
            ...
            itemDropController.OnBoosterActivated(ItemDropTypeEnum.ScoreBoost, true);
        ...
        {
            tutorialController.BoosterTutorialPass(ItemDropTypeEnum.ScoreBoost);
        }
